...
class Technology extends Component {
    ...
    this.state = {
        ...
        data : Array(10),
         url:
          'https://nodeserver-env.eba-dtbeadtp.us-east-2.elasticbeanstalk.com/technology'
    };
    }
  ...
  componentDidMount() {
    ...
    const url =
    'https://content.guardianapis.com/technology?api-key=ee45af7a-ea6c-49ca-8925-25269dab0e0d&show-blocks=all'
